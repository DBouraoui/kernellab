                                ...
                                >
                                    ...
                                    <div className="relative h-56 w-full overflow-hidden bg-muted/30">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            <Badge className="border-0 bg-background/80 backdrop-blur-md text-foreground hover:bg-background font-bold px-3 py-1.5 rounded-full text-[10px] uppercase tracking-wider flex items-center gap-2 shadow-sm">
